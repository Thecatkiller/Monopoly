...
//funcion degirar icono de la tanbla
$(".slide_tr").click(function () {
    $(this).children('.table_center').children('i').toggleClass('rotateIcon');
});
